  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine: Empowering restaurants with seamless table reservations and menu management. An app where customers meet convenience, and employees meet efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine: Empowering restaurants with seamless table reservations and menu management. An app where customers meet convenience, and employees meet efficiency.`}
            </Text>
            <Box
